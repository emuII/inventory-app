    ...
    public function GetProductOut()
    {
        ...
        foreach ($data as $index => $row) {
            echo "<tr>
                    ...
                    <td style='width: 15%;'>
                        <a href='index.php?route=productIn/edit&product_code={$row['product_id']}' class='btn btn-sm btn-primary'>Edit</a>
                        <a href='service/brandService.php?delete_brand=delete&product_code={$row['product_id']}'
