...
class deliveryOrderModel
{
    ...
    public function getDeliveryOrderByCode($deliveryCode)
    {
        $sql = "SELECT 
                    ...
                    FORMAT((DVO.total_amount), 0, 'id_ID') subTotal
    ...
    public function submitDeliveryOrder(array $data)
    {
        ...
        try {
            $sqlDo = "INSERT INTO delivery_order (do_code, invoice_number, do_date, status, total_amount, created_at)
                VALUES (:do_code, :invoice_number,  NOW(), :status, :total_amount, NOW())";
